		...
		return (
			<div className="carousel-inner bg-color-white-slider">
				<div className="item active">
					<SliderImg slide={slide[0]} />
					<div className="container carousel-caption">
						<div className="row">
							<Slide left cascade>
								<div className="col-sm-12 col-sm-offset0 text-left sr1222">
									<h3>
										Marketing <span className="text-primary">mówi </span> do ludzi
									</h3>
									<h3>
										Content marketing z nimi <span className="text-primary">rozmawia</span>
									</h3>
								</div>
							</Slide>
						</div>
				...
				<div className="item">
					<SliderImg slide={slide[1]} />
					<Slide left>
						<div className="carousel-caption text-right sr111">
							<h3 className="text-right">
								Komuniakcja jest <span className="text-primary">strategią.</span>
							</h3>
							<Button
								link="/kontakt"
								textAlign="text-right"
								text="Napisz do nas"
								buttonClass="btn-slider"
							/>
						</div>
					</Slide>
				</div>
